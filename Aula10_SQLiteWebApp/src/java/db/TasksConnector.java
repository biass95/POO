...
public class TasksConnector {
    ...
    private static final String URL = "jdbc:sqlite:/Users/biancasobral/Desktop/tasks-noturno.db";
    ...
    //Criar métodos: select(); insert(); delete().
    //SENDO QUE O SELECT RETORNA UM ARRAYLIST DE STRINGS.
